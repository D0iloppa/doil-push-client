...
function registerPush(appPubkey) {
    navigator.serviceWorker.register('resource/service-worker/sw.js').then( (registration) =>{
        ...
        return registration.pushManager.getSubscription()
            ...
            .then(function(subscription) {
                ...
                return fetch('http://192.168.0.11:3939/subscribe.do', {
                    method: 'post',
...
document.querySelector('#subscribe_Btn').onclick = () =>{
    ...
    if (navigator.serviceWorker) {
        ...
        fetch('http://192.168.0.11:3939/getServerKey.do')
